#he is_palindrome function checks if a string is a palindrome. A palindrome is a string that can be equally
#read from left to right or right to left, omitting blank spaces, and ignoring capitalization. 
